---
title: Platform 2.16 Libraries - Firefly Graph
description: Libraries and import specifiers available to plugins targeting Graph platform version 2.16.
---

# Platform 2.16 — Available Libraries

This page lists every library a plugin can import when it targets Graph platform **2.16**. To target this release, set `platformVersion` to `{ "major": 2, "minor": 16 }` in the plugin's manifest. Each library below is provided by the platform at runtime, so you import it directly — there's no need to add it to your project's dependencies. Versions are the ranges guaranteed available in this release.
...
* [@babylonjs/loaders](#babylonjsloaders)
...
@graph/platform-exports/widget-resize-controller.js
@graph/platform-exports/v1/widget-resize-controller.js
@graph/platform-exports/widget-resizing-context.js
@graph/platform-exports/v1/widget-resizing-context.js
@graph/platform-exports/sizing.js
@graph/platform-exports/v1/sizing.js
```
...
@babylonjs/core/Shaders/depth.fragment.js
@babylonjs/core/Shaders/color.vertex.js
@babylonjs/core/Shaders/color.fragment.js
